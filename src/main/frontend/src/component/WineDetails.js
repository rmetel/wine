...
class WineView extends React.Component {
  constructor(props) {
    super(props);
    this.state = {wine: [], isLoaded: false};
  }
  ...
  componentDidMount() {
    ...
    fetch(isLocal? urlLocal + endPoint : endPoint)
      ...
      .then(data => this.setState({wine: data, isLoaded: true}));
  }

  render() {
    const {wine, isLoaded} = this.state;
                    ...
                    <div className="col-md-6">
                      <div className="product p-4">
                        ...
                        <div className="mb-3">
                          ...
                          <span className="text-muted brand">{wine.region.name}, {wine.country.name}</span>
                        </div>
                        <h5 className="">Weinbeschreibung</h5>
                        <p className="about">
                          Der tief granatrote Wein bietet alles, was man von einem {wine.region.name} Wein erwartet.
